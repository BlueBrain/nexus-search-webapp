...
},{"emoji-named-characters":20,"lodash.shuffle":21}],22:[function(require,module,exports) {
var bundleURL = null;
...
function randomizeEmoji() {
  return _randomEmoji2.default.random({ count: 5 }).map(function (entry) {
...
exports.default = {
  ...
  methods: {
    randomEmoji: function randomEmoji() {
      this.message = randomizeEmoji();
    }
  }
};
        var $f01531 = exports.default || module.exports;
      
      if (typeof $f01531 === 'function') {
        $f01531 = $f01531.options;
      }
    
        /* template */
        Object.assign($f01531, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "app" } }, [
    _c("button", { on: { click: _vm.randomEmoji } }, [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f01531', $f01531);
          } else {
            api.reload('$f01531', $f01531);
          }
        }
...
},{"random-emoji":17,"_css_loader":19,"vue-hot-reload-api":18,"vue":11}],7:[function(require,module,exports) {
'use strict';
...
},{"vue":11,"./components/App.vue":9}],5:[function(require,module,exports) {
"use strict";
...
var EXTENSION_ELEMENT = window.extension;
console.log("hello world");

(0, _index2.default)(EXTENSION_ELEMENT);
},{"./index.js":7}],23:[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/mock.114ffd92.map