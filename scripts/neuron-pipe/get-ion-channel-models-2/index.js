...
const config = getConfig("get-ion-channel-models-2", stage);
...
async function fetch() {
  ...
  let [error, docs] = await to(
    waitForEach(getResources(easyConfig), [
      ...
      //     }
      //   );
      //   let generatedFrom = response.total > 0 ? response.results[0].resultId : null;
      ...
      async doc => {
        ...
        attribution.fullName = attribution.givenName + " " + attribution.familyName;
